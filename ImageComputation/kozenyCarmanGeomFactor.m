function [ geomFactor ] = ...
    kozenyCarmanGeomFactor( permeability, phi, ssa, ...
                            tortuosity, dl )
%kozenyCarmanGeomFactor computes geometrical factor using Kozeny-Carman Eq.
...
geomFactor = permeability ./ (m2tomD .* phi.^3 ./ ...
             ((ssa).^2 .* tortuosity.^2));
